...
class hanoitower
{
    public _centpt:Point;
    public canvas:HTMLCanvasElement;
    public context:CanvasRenderingContext2D;
    public disc_no:number = 0;
    public toMovevertically:boolean=false;
    public toMovehorizontal:boolean=false;
    constructor(canvas:HTMLCanvasElement,context:CanvasRenderingContext2D,disc_no:number,centpt:Point,no:number)
    {
        this.canvas=canvas;
...
//Tower 1 to tower 2 Complete Animation-----------------------------------------------------------------------------------
    ...
    move1_to_2_vdown(elevation:number)
    {
        var temp:number;
...
move1_to_3_vdown(elevation:number)
{
    var temp:number;
    if(this.toMovevertically)
    {
...
move2_to_3_vdown(elevation:number)
{
    var temp:number;
    if(this.toMovevertically)
    {
...
move3_to_2_vdown(elevation:number)
{
    var temp:number;
    if(this.toMovevertically)
    {
...
move2_to_1_vdown(elevation:number)
{
    var temp:number;
    if(this.toMovevertically)
    {
...
move3_to_1_vdown(elevation:number)
{
    var temp:number;
    if(this.toMovevertically)
    {
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    reactangle(x:number,y:number,w:number,h:number,color:string)
    {
