...
var user_no;
var flag_moves = 0;
var from_disc = new Array(4);
var count_moves = 0;
var tower1_top_disc = -1;
var tower1_second_disc;
var tower2_second_disc;
var tower3_second_disc;
var tower2_top_disc = -1;
var tower3_top_disc = -1;
var to_disc = new Array(4);
var count_step = -1;
var tower1_store = new Array(4);
var tower2_store = new Array(4);
var tower3_store = new Array(4);
var tower1_disc_count;
var tower2_disc_count = 0;
var tower3_disc_count = 0;
user_no = prompt("Please Enter the number of disc For Hanoi Tower");
var no;
no = parseInt(user_no);
function hanoi(no, a, b, c) {
    if (no > 0) {
        hanoi(no - 1, a, c, b);
        console.log(a + " to " + c);
...
function reactangle(x, y, w, h, color) {
